...
const CHANGE_LOG_ENTRIES = [
  ...
  },
  {
    ...
    items: [
			...
			'Bake: Fixed bug',
			'MeshEditor - Optimize: Updated to latest version'
    ]
  },
  {
    version: 'v3.4.0',
  ...
  },
  {
    ...
    date: '2026-08-27',
    items: [
			'Animations: Integrated MoCapAnythingV2 (video-to-motion)',
			'MeshEditor: Added viewport gizmo and Perspective/Orthographic view',
			'Updated npm packages',
			'Fixed startup speed in dev mode',
